...
public class BuildScripts : MonoBehaviour
{
    ...
    //{
    //        "Assets/ZimmerBiomet/TibiaPainting/Scenes/Full.unity",
    //    };
    ...
    //    AddressableAssetProfileSettings profileSettings = AssetDatabase.LoadAssetAtPath<AddressableAssetSettings>(assetPath).profileSettings;
    ...
    //[MenuItem("Zimmer Biomet/Build Project (Dev)")]
    ///// <summary>
    ///// Build the HoloLens app for dev from the Unity Editor
    ///// </summary>
    //public static void sBuildDev()
    //{
    //    sBuildAddressables();
    ...
    //{
    //    Debug.Log($"Building {options.locationPathName} for target {options.target} with options {options.options}");
    ...
    //            success = true;
    //            Debug.Log($"Build succeeded - {options.locationPathName} for target {options.target} with options {options.options}");
    //            break;
    //        case BuildResult.Unknown: // fall-through to failed case
    //        case BuildResult.Failed:
    //            Debug.Log($"Build failed - {options.locationPathName} for target {options.target} with options {options.options}");
    //            break;
